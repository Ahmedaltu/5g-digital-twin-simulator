...
REQUIRED_COLUMNS = ["timestep", "base_station_id", "users", "demand", "throughput", "cell_load"]
...
if not df.empty:
	...
	col3.metric("Cell Load", f"{last_row['cell_load']:.2f}")
	col4.metric("Traffic Demand (Mbps)", f"{last_row['demand']:.2f}")
